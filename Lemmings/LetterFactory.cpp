...
Sprite* LetterFactory::createLetter(char c) {
	Sprite *letterSprite = Sprite::createSprite(glm::ivec2(18, 24), glm::vec2(18./32, 24./4096), &ShaderManager::getInstance().getShaderProgram(), &Game::spriteSheets().greenNumLetters);
